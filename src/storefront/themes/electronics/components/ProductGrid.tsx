// ProductGrid do tema Electronics — densidade média sem perder legibilidade.
// Grid 2/3/4 colunas e rail horizontal para destaques.
  ...
  if (layout === "rail") {
    ...
    return (
      <div className="group/rail relative">
        <div ref={railRef} className="no-scrollbar flex snap-x snap-mandatory gap-3 overflow-x-auto pb-1 scroll-smooth">
          {visible.map((p) => (
