// ProductCard do tema Fresh Market — preço e botão de adicionar muito claros
// para compras rápidas e recorrentes. Imagem 1:1 em fundo tint (padded-tint)
// com zoom no hover e botão de adicionar sempre visível.
