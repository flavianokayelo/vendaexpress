// Página aberta de produto do tema Modern. Consome a StorefrontApi (com
// route.productId) e deriva tudo da lista de dados do engine — nunca faz fetch.
...
export function ProductPage(api: StorefrontApi) {
    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 pb-24 sm:pb-6">
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div>
            <div
              className="relative aspect-square w-full overflow-hidden rounded-[10px] bg-[var(--sf-surface-muted)]"
              onClick={() => {
              ...
              <div className="mt-3 flex gap-2 overflow-x-auto pb-1">
                {media.map((m, i) => (
                  <button
                    ...
                    className={`relative h-16 w-16 flex-shrink-0 overflow-hidden rounded-[8px] border-2 transition-opacity ${
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              <div className="flex items-center rounded-[6px] border border-[var(--sf-line)]">
                <button
              ...
              <motion.button
                ...
                className={`inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-[6px] px-6 text-[14px] font-semibold transition-[background-color,box-shadow] duration-200 ${
                  justAdded
            ...
            {product.return_policy && (
              <div className="mt-6 flex gap-2 rounded-[8px] bg-[var(--sf-surface-muted)] p-3 text-xs text-[var(--sf-ink-secondary)]">
          ...
          <div className="mt-14">
            <Reveal className="mb-5 flex items-center gap-3.5">
              <h2 className="relative font-display text-[24px] font-semibold tracking-[-0.015em] text-[var(--sf-ink)]">
                <span className="absolute -left-3 top-1/2 h-5 w-1 -translate-y-1/2 rounded-full" style={{ background: "var(--sf-primary)" }} />
                Também pode gostar
              </h2>
            </Reveal>
            <ProductGrid
      ...
      <div className="fixed inset-x-0 bottom-0 z-30 flex items-center gap-3 border-t border-[var(--sf-line)] bg-[var(--sf-surface)] px-4 py-3 shadow-[0_-2px_10px_rgba(0,0,0,0.08)] sm:hidden">
        ...
        <motion.button
          ...
          onClick={handleAddToCart}
          whileTap={product.stock <= 0 ? undefined : { scale: 0.97 }}
          className={`inline-flex h-11 flex-1 items-center justify-center gap-2 rounded-[6px] px-4 text-[14px] font-semibold transition-colors ${
            justAdded
              ? "bg-[var(--sf-success)] text-white"
              : product.stock <= 0
                ? "cursor-not-allowed bg-slate-200 text-slate-400"
